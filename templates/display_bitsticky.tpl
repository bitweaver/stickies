...
{if $gBitSystem->isPackageActive( 'stickies' ) and $stickyInfo}
	{box title="Personal Note: `$stickyInfo.title`" class="stickynote"}
		<div class="floaticon">
			...
			<a href="{$smarty.const.STICKIES_PKG_URL}edit.php?notated_content_id={$stickyInfo.notated_content_id}&amp;delete=1">{biticon ipackage="icons" iname="edit-delete" iexplain="delete sticky"}</a>
		</div>
		{$stickyInfo.parsed}
		<div class="footer">
